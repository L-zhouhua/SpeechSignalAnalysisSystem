...
public:
    ...
    QToolBox *type_toolBox_fir;
    QWidget *page_9;
    QVBoxLayout *verticalLayout_13;
    QLabel *label_30;
    QLineEdit *order_edit_fir_LP;
    QLabel *label_31;
    QLineEdit *parameter_edit_fir_LP;
    QLabel *label;
    QComboBox *winfunc_box_LP;
    QLabel *kai_lab_LP;
    QLineEdit *kai_edit_LP;
    QPushButton *affirm_but_fir_LP;
    QWidget *page_10;
    QVBoxLayout *verticalLayout_8;
    QLabel *label_33;
    QLineEdit *order_edit_fir_HP;
    QLabel *label_32;
    QLineEdit *parameter_edit_fir_HP;
    QLabel *label_7;
    QComboBox *winfunc_box_HP;
    QLabel *kai_lab_HP;
    QLineEdit *kai_edit_HP;
    QPushButton *affirm_but_fir_HP;
    QWidget *page_11;
    QVBoxLayout *verticalLayout_9;
    QLabel *label_35;
    QLineEdit *order_edit_fir_BP;
    QLabel *label_34;
    QLineEdit *parameter_edit_fir_BP;
    QLabel *label_36;
    QLineEdit *parameter_edit_2_fir__BP;
    QLabel *label_8;
    QComboBox *winfunc_box_BP;
    QLabel *kai_lab_BP;
    QLineEdit *kai_edit_BP;
    QPushButton *affirm_but_fir_BP;
    QWidget *page_12;
    QVBoxLayout *verticalLayout_14;
    QLabel *label_37;
    QLineEdit *order_edit_fir_BS;
    QLabel *label_38;
    QLineEdit *parameter_edit_fir_BS;
    QLabel *label_39;
    QLineEdit *parameter_edit_2_fir_BS;
    QLabel *label_18;
    QComboBox *winfunc_box_BS;
    QLabel *kai_lab_BS;
    QLineEdit *kai_edit_BS;
    QPushButton *affirm_but_fir_BS;
    QGroupBox *groupBox_5;
    QVBoxLayout *verticalLayout_12;
    QCustomPlot *freqyres_widget_fir;
    ...
    QLabel *label_41;
    QLabel *order_lab_fir;
    QHBoxLayout *horizontalLayout_11;
    QLabel *label_42;
    QLabel *parameter_lab_fir;
    QHBoxLayout *horizontalLayout_12;
    QLabel *label_43;
    QLabel *parameter_lab_fir_2;
    QPlainTextEdit *plainTextEdit_fir;

    void setupUi(QWidget *FreqyRes)
    {
        if (FreqyRes->objectName().isEmpty())
            FreqyRes->setObjectName(QString::fromUtf8("FreqyRes"));
        FreqyRes->resize(1339, 549);
        ...
        type_toolBox_fir = new QToolBox(groupBox_6);
        ...
        order_edit_fir_LP = new QLineEdit(page_9);
        order_edit_fir_LP->setObjectName(QString::fromUtf8("order_edit_fir_LP"));
        order_edit_fir_LP->setFocusPolicy(Qt::StrongFocus);
        order_edit_fir_LP->setEchoMode(QLineEdit::Normal);

        verticalLayout_13->addWidget(order_edit_fir_LP);
        ...
        parameter_edit_fir_LP = new QLineEdit(page_9);
        parameter_edit_fir_LP->setObjectName(QString::fromUtf8("parameter_edit_fir_LP"));

        verticalLayout_13->addWidget(parameter_edit_fir_LP);
        ...
        winfunc_box_LP = new QComboBox(page_9);
        winfunc_box_LP->addItem(QString());
        winfunc_box_LP->addItem(QString());
        winfunc_box_LP->addItem(QString());
        winfunc_box_LP->addItem(QString());
        winfunc_box_LP->addItem(QString());
        winfunc_box_LP->addItem(QString());
        winfunc_box_LP->setObjectName(QString::fromUtf8("winfunc_box_LP"));

        verticalLayout_13->addWidget(winfunc_box_LP);
        ...
        kai_edit_LP = new QLineEdit(page_9);
        kai_edit_LP->setObjectName(QString::fromUtf8("kai_edit_LP"));
        kai_edit_LP->setEnabled(false);

        verticalLayout_13->addWidget(kai_edit_LP);

        affirm_but_fir_LP = new QPushButton(page_9);
        affirm_but_fir_LP->setObjectName(QString::fromUtf8("affirm_but_fir_LP"));
        affirm_but_fir_LP->setEnabled(true);
        affirm_but_fir_LP->setMaximumSize(QSize(16777215, 16777215));
        affirm_but_fir_LP->setIconSize(QSize(20, 20));

        verticalLayout_13->addWidget(affirm_but_fir_LP);
        ...
        order_edit_fir_HP = new QLineEdit(page_10);
        order_edit_fir_HP->setObjectName(QString::fromUtf8("order_edit_fir_HP"));

        verticalLayout_8->addWidget(order_edit_fir_HP);
        ...
        parameter_edit_fir_HP = new QLineEdit(page_10);
        parameter_edit_fir_HP->setObjectName(QString::fromUtf8("parameter_edit_fir_HP"));

        verticalLayout_8->addWidget(parameter_edit_fir_HP);
        ...
        winfunc_box_HP = new QComboBox(page_10);
        winfunc_box_HP->addItem(QString());
        winfunc_box_HP->addItem(QString());
        winfunc_box_HP->addItem(QString());
        winfunc_box_HP->addItem(QString());
        winfunc_box_HP->addItem(QString());
        winfunc_box_HP->addItem(QString());
        winfunc_box_HP->setObjectName(QString::fromUtf8("winfunc_box_HP"));

        verticalLayout_8->addWidget(winfunc_box_HP);
        ...
        kai_edit_HP = new QLineEdit(page_10);
        kai_edit_HP->setObjectName(QString::fromUtf8("kai_edit_HP"));
        kai_edit_HP->setEnabled(false);

        verticalLayout_8->addWidget(kai_edit_HP);

        affirm_but_fir_HP = new QPushButton(page_10);
        affirm_but_fir_HP->setObjectName(QString::fromUtf8("affirm_but_fir_HP"));
        affirm_but_fir_HP->setEnabled(true);
        affirm_but_fir_HP->setMaximumSize(QSize(16777215, 16777215));
        affirm_but_fir_HP->setIconSize(QSize(20, 20));

        verticalLayout_8->addWidget(affirm_but_fir_HP);
        ...
        order_edit_fir_BP = new QLineEdit(page_11);
        order_edit_fir_BP->setObjectName(QString::fromUtf8("order_edit_fir_BP"));

        verticalLayout_9->addWidget(order_edit_fir_BP);
        ...
        parameter_edit_fir_BP = new QLineEdit(page_11);
        parameter_edit_fir_BP->setObjectName(QString::fromUtf8("parameter_edit_fir_BP"));

        verticalLayout_9->addWidget(parameter_edit_fir_BP);
        ...
        parameter_edit_2_fir__BP = new QLineEdit(page_11);
        parameter_edit_2_fir__BP->setObjectName(QString::fromUtf8("parameter_edit_2_fir__BP"));

        verticalLayout_9->addWidget(parameter_edit_2_fir__BP);
        ...
        winfunc_box_BP = new QComboBox(page_11);
        winfunc_box_BP->addItem(QString());
        winfunc_box_BP->addItem(QString());
        winfunc_box_BP->addItem(QString());
        winfunc_box_BP->addItem(QString());
        winfunc_box_BP->addItem(QString());
        winfunc_box_BP->addItem(QString());
        winfunc_box_BP->setObjectName(QString::fromUtf8("winfunc_box_BP"));

        verticalLayout_9->addWidget(winfunc_box_BP);
        ...
        kai_edit_BP = new QLineEdit(page_11);
        kai_edit_BP->setObjectName(QString::fromUtf8("kai_edit_BP"));
        kai_edit_BP->setEnabled(false);

        verticalLayout_9->addWidget(kai_edit_BP);

        affirm_but_fir_BP = new QPushButton(page_11);
        affirm_but_fir_BP->setObjectName(QString::fromUtf8("affirm_but_fir_BP"));
        affirm_but_fir_BP->setEnabled(true);
        affirm_but_fir_BP->setMaximumSize(QSize(16777215, 16777215));
        affirm_but_fir_BP->setIconSize(QSize(20, 20));

        verticalLayout_9->addWidget(affirm_but_fir_BP);
        ...
        order_edit_fir_BS = new QLineEdit(page_12);
        order_edit_fir_BS->setObjectName(QString::fromUtf8("order_edit_fir_BS"));

        verticalLayout_14->addWidget(order_edit_fir_BS);

        label_38 = new QLabel(page_12);
        label_38->setObjectName(QString::fromUtf8("label_38"));
        label_38->setMaximumSize(QSize(16777215, 50));

        verticalLayout_14->addWidget(label_38);

        parameter_edit_fir_BS = new QLineEdit(page_12);
        parameter_edit_fir_BS->setObjectName(QString::fromUtf8("parameter_edit_fir_BS"));

        verticalLayout_14->addWidget(parameter_edit_fir_BS);
        ...
        parameter_edit_2_fir_BS = new QLineEdit(page_12);
        parameter_edit_2_fir_BS->setObjectName(QString::fromUtf8("parameter_edit_2_fir_BS"));

        verticalLayout_14->addWidget(parameter_edit_2_fir_BS);
        ...
        winfunc_box_BS = new QComboBox(page_12);
        winfunc_box_BS->addItem(QString());
        winfunc_box_BS->addItem(QString());
        winfunc_box_BS->addItem(QString());
        winfunc_box_BS->addItem(QString());
        winfunc_box_BS->addItem(QString());
        winfunc_box_BS->addItem(QString());
        winfunc_box_BS->setObjectName(QString::fromUtf8("winfunc_box_BS"));

        verticalLayout_14->addWidget(winfunc_box_BS);
        ...
        kai_edit_BS = new QLineEdit(page_12);
        kai_edit_BS->setObjectName(QString::fromUtf8("kai_edit_BS"));
        kai_edit_BS->setEnabled(false);

        verticalLayout_14->addWidget(kai_edit_BS);

        affirm_but_fir_BS = new QPushButton(page_12);
        affirm_but_fir_BS->setObjectName(QString::fromUtf8("affirm_but_fir_BS"));
        affirm_but_fir_BS->setEnabled(true);
        affirm_but_fir_BS->setMaximumSize(QSize(16777215, 16777215));
        affirm_but_fir_BS->setIconSize(QSize(20, 20));

        verticalLayout_14->addWidget(affirm_but_fir_BS);

        type_toolBox_fir->addItem(page_12, QString::fromUtf8("\345\270\246\351\230\273\346\273\244\346\263\242\345\231\250"));

        gridLayout_4->addWidget(type_toolBox_fir, 0, 0, 1, 1);
        ...
        freqyres_widget_fir = new QCustomPlot(groupBox_5);
        freqyres_widget_fir->setObjectName(QString::fromUtf8("freqyres_widget_fir"));

        verticalLayout_12->addWidget(freqyres_widget_fir);
        ...
        type_lab_fir = new QLabel(groupBox_7);
        type_lab_fir->setObjectName(QString::fromUtf8("type_lab_fir"));

        horizontalLayout_9->addWidget(type_lab_fir);
        ...
        order_lab_fir = new QLabel(groupBox_7);
        order_lab_fir->setObjectName(QString::fromUtf8("order_lab_fir"));

        horizontalLayout_10->addWidget(order_lab_fir);
        ...
        horizontalLayout_11->addWidget(label_42);

        parameter_lab_fir = new QLabel(groupBox_7);
        parameter_lab_fir->setObjectName(QString::fromUtf8("parameter_lab_fir"));

        horizontalLayout_11->addWidget(parameter_lab_fir);
        ...
        parameter_lab_fir_2 = new QLabel(groupBox_7);
        parameter_lab_fir_2->setObjectName(QString::fromUtf8("parameter_lab_fir_2"));

        horizontalLayout_12->addWidget(parameter_lab_fir_2);


        verticalLayout_15->addLayout(horizontalLayout_12);

        plainTextEdit_fir = new QPlainTextEdit(groupBox_7);
        plainTextEdit_fir->setObjectName(QString::fromUtf8("plainTextEdit_fir"));
        plainTextEdit_fir->setEnabled(true);
        plainTextEdit_fir->setMaximumSize(QSize(16777215, 16777215));
        plainTextEdit_fir->setReadOnly(true);

        verticalLayout_15->addWidget(plainTextEdit_fir);


        gridLayout_5->addWidget(groupBox_7, 0, 2, 1, 1);
